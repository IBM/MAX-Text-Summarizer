...
As you can see, the text summarizer not only gives the summary text but also filters out some special characters such as `-lrb- `, `-rrb-` and `@highlight`, etc, from the [Daily Mail](https://github.com/abisee/cnn-dailymail) dataset. 
